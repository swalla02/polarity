...
def get_comments_and_polarity_with_limit(input_data: inputData):
    ...
    output = outputData(comments=[
        outputComment(id=comment['id'], text=comment['text'], polarity=comment['polarity'], polarity_score=comment['polarity_score'])
...
def get_comments_and_polarity_with_time_range(input_data: inputData_with_time):
    ...
    try:
        comments_list = get_subfeddit_comments_with_time_range(subfeddit_id, time_range)
    except HTTPException as e:
        raise e
    output = outputData_with_time(comments_with_time=[
        outputComment_with_time(id=comment['id'], text=comment['text'], polarity=comment['polarity'], polarity_score=comment['polarity_score'], created_at=comment['created_at'])
